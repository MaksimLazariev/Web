// Задача 1. Необходимо создать html-страницу с названием 1.html, в которой подключить 
// файл 1.js (его тоже необходимо создать рядом с html-файлом). В js-файле необходимо 
...
// и вывести в alert сообщение с текстом (пример): 
...
const celsius = Number.parseFloat(prompt("Введите температуру по цельсию"));
const fahrenheit = Math.floor(((9 / 5) * celsius + 32)*100) / 100;
